  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        budget: form.budget.trim().length > 0 ? Number(form.budget) : null,

        grade:
          gradeRaw != null && Number.isFinite(gradeRaw) ? gradeRaw : null,
        session_minutes:
        ...
        preferred_days: parseCsv(form.preferredDays),

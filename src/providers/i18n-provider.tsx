...
const DICTS: Record<Locale, Dictionary> = {
  en: {
    ...
    "proposal.status.withdrawn": "Withdrawn",
    "proposal.action.shortlist": "Shortlist",
    "proposal.action.hire": "Hire",
    "proposal.action.decline": "Decline",
    "proposal.action.message": "Message",
    "proposal.action.scheduleInterview": "Schedule Interview",
    "proposal.action.reschedule": "Reschedule",
    "proposal.interview.scheduled": "Interview Scheduled",
    "proposal.interview.completed": "Interview Completed",
